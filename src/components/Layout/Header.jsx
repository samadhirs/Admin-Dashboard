import { Menu, Plus, Sun, Bell, ChevronDown } from "lucide-react";
import { Settings } from "lucide-react";
import React from 'react'

function Header({ sidebarCollapesed, onToggleSidebar }) {
  return (
    <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200/50 
      ...
      <div className="flex items-center justify-between h-full">
        ...
        <div className="flex-1 max-w-md mx-8">
          <div className="relative">
            ...
            type="text" 
            placeholder="Search" 
            className="w-full pl-4 pr-3 py-2.5 bg-slate-100 dark:bg-slate-800 border 
        ...
        hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
          ...
          <span className="absolute -top-1 w-4 h-4 bg-red-500 text-white text-xs 
